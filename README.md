...
![Release](https://img.shields.io/badge/release-v0.7.1-2EA44F?style=flat-square)

</div>

> [!NOTE]
> **Current release: v0.7.1.** See the [Changelog](CHANGELOG.md) for release details and the [Roadmap](docs/ROADMAP.md) for future work.
