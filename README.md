...
1. Download the latest `FrameHub_Setup` installer from Releases.
2. Install FrameHub.
3. Close CS2 before using the CS2 Config module.
4. Run FrameHub normally.
5. Run as administrator only when Windows requires elevated permissions for process optimization.
6. Add or scan games in the Library.
7. Create or apply CPU profiles.
8. Use Config only when CS2 is closed.
