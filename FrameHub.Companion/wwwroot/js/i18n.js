(function () {
    ...
    const translations = {
        en: {
            ...
            'optimization.cpu.title': 'CPU configuration',
            ...
            'optimization.cpu.edit': 'Edit CPU for this session',
            ...
            'optimization.cpu.restoreOriginal': 'Restore original settings',
            'optimization.cpu.sessionOnlyNotice': 'Changes apply only to the current game session and are not saved to the profile.',
            'optimization.cpu.noGame': 'No active game.',
            'optimization.cpu.unavailable': 'CPU control unavailable.',
            'optimization.cpu.protected': 'CPU control is unavailable for this protected game.',
            'optimization.cpu.permission': 'Permission required. Grant this device Session CPU permissions in FrameHub settings.',
        ...
        pl: {
            ...
            'optimization.cpu.title': 'Konfiguracja CPU',
            'optimization.cpu.sourceSystem': 'System',
            'optimization.cpu.sourceProfile': 'Profil gry',
            'optimization.cpu.sourceOverride': 'Tymczasowe zastąpienie',
            'optimization.cpu.affinity': 'Koligacja',
            'optimization.cpu.cpuSets': 'Zestawy CPU',
            'optimization.cpu.none': 'Brak',
            'optimization.cpu.edit': 'Dostosuj CPU dla tej sesji',
            ...
            'optimization.cpu.restoreOriginal': 'Przywróć pierwotne ustawienia',
            'optimization.cpu.sessionOnlyNotice': 'Zmiany dotyczą tylko bieżącej sesji gry i nie są zapisywane w profilu.',
            'optimization.cpu.noGame': 'Brak aktywnej gry.',
            'optimization.cpu.unavailable': 'Sterowanie CPU niedostępne.',
            'optimization.cpu.protected': 'Sterowanie CPU jest niedostępne dla tej chronionej gry.',
            'optimization.cpu.permission': 'Wymagane uprawnienie. Nadaj temu urządzeniu uprawnienia „CPU sesji” w ustawieniach FrameHub.',
