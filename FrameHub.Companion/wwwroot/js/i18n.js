(function () {
    ...
    const translations = {
        en: {
            ...
            'optimization.cpu.title': 'Game CPU Control',
            ...
            'optimization.cpu.permission': 'This device does not have permission for Game CPU Control.',
        ...
        pl: {
            ...
            'optimization.cpu.title': 'Sterowanie CPU gry',
            ...
            'optimization.cpu.protected': 'Sterowanie CPU jest niedostępne dla tej gry ze względu na zasady bezpieczeństwa.',
            'optimization.cpu.permission': 'To urządzenie nie ma uprawnienia do sterowania CPU gry.',
